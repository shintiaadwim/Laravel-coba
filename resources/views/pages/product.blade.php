    ...
    <div class="p-4 sm:ml-64">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs truncate text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                ...
                <tbody>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4 truncate">Rp. {{ $data->harga_product }} </td>
                        <td class="px-6 py-4">
